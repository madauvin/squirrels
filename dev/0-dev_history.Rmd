...
fusen::fill_description(
  pkg = here::here(),
  fields = list(
    Title = "Study the squirrels of Central park",
    Description = "Provide everything need to study the squirrels' population in Central Park, NYC.",
    `Authors@R` = c(
...
```{r, eval=FALSE}
usethis::use_git()
usethis::use_git_remote("origin", url="https://github.com/madauvin/squirrels.git", 
                    overwrite=TRUE)
...
# Code of Conduct
usethis::use_code_of_conduct("helpdesk@fake.com")
# NEWS
usethis::use_news_md()
